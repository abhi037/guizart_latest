      ...
      <div class="panel-body">
        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            <a href = "<?php echo site_url('admin/video_form/add_video'); ?>" class="btn btn-block btn-info btn-lg" type="button">
                ...
                <div class="btn-group">
                  <button class="btn btn-small btn-default btn-demo-space" data-toggle="dropdown"> <i class = "fa fa-ellipsis-v"></i> </button>
                    <ul class="dropdown-menu dropdown-default" role="menu">
                      <li>
                        <a href="<?php echo site_url('admin/video_form/video_edit/' . $video['id']); ?>">
                          <?php echo get_phrase('edit');?>
                        </a>
                      </li> 
                      <li class="divider"></li>
                      <li>
                        <a href="#" onclick="confirm_modal('<?php echo site_url('admin/video_actions/delete/' . $video['id']); ?>');">
