...
<html lang="en" dir="<?php if ($text_align == 'right-to-left') echo 'rtl'; ?>">
  ...
  <!-- END HEAD -->
<body class="page-body" data-url="http://neon.dev" style="max-height: 1000px;max-width: 1600px;/* justify-content: center; *//* text-align: center; */overflow-x: hidden;margin: 0 auto;">
    <!-- BEGIN CONTAINER -->
