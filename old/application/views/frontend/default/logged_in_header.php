          ...
          <div class="user-box menu-icon-box">
            ...
            <div class="dropdown user-dropdown corner-triangle top-right">
              <ul class="user-dropdown-menu">
                  ...
                  <a href="">
                    <div class="clearfix">
                      <div class="user-image float-left">
                        <?php if (file_exists(base_url(). 'uploads/user_image/'.$user_details['id'].'.jpg') || file_exists('uploads/user_image/'.$user_details['id'].'.jpg')): ?>
                          <img src="<?php echo base_url().'uploads/user_image/'.$user_details['id'].'.jpg';?>" alt="" class="img-fluid">
                        <?php else: ?>
                          <img src="<?php echo base_url().'uploads/user_image/placeholder.png';?>" alt="" class="img-fluid">
                        <?php endif; ?>
                ...
                <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_enroll'); ?>"><i class="far fa-gem"></i><?php echo get_phrase('enrolled_quizzes'); ?></a></li>
                <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/previousExams'); ?>"><i class="far fa-gem"></i><?php echo get_phrase('previous_quizzes'); ?></a></li>
