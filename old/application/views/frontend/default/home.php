...
<section class="popular-courses-area ptb-100">
    ...
    ?>
      ...
      <!--<section class="home-fact-area" style="background-image: url(<?php echo base_url() . 'uploads/' . $sliderimg; ?>); background-position: center; background-repeat: no-repeat;  background-size: cover;">
				<h1> &nbsp; </h1>
			</section>-->
			<img src="<?php echo base_url() . 'uploads/' . $sliderimg; ?>" style="max-width: -webkit-fill-available;margin-bottom:10px;"/>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-courses-item">
						...
						<div class="courses-content-bottom">
							...
							?>
							<h4><a href="<?php echo ($exam['disabled']==1 ?  'javascript:void(0)' : (site_url('home/category/'). slugify($exam['name']) .'/'.$exam['id'])); ?>" ><button 
							<?php echo ($exam['disabled']==1 ? 'class="btn" style="background-color: darkslategray;"' : 'class="btn btn-primary"'); ?>><?php echo ($exam['disabled']==1 ? 'Coming Soon' : 'Enroll Now'); ?></button></a></h4>
              <?php
								endif;
							/*
