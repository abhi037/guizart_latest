        ...
        <footer class="footer-area" style="background-color:#2b2929;">
            <div class="container-xl">
                <div class="row"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright-text">
                            ...
                            <a href="<?php echo get_settings('footer_link'); ?>" target="_blank" style="color:white"><?php echo get_settings('footer_text'); ?></a>
                        </p>
                    </div>
                    <div class="col-md-6">
                        <ul class="nav justify-content-md-end footer-menu">
                           ...
                           <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/pages/about_us'); ?>" style="color:white;"><?php echo get_phrase('about_us'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/pages/contact_us'); ?>" style="color:white;"><?php echo get_phrase('contact_us'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/faqs'); ?>" style="color:white;"><?php echo get_phrase('FAQs'); ?></a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/privacy_policy'); ?>" style="color:white;"><?php echo get_phrase('privacy_policy'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/terms_and_condition'); ?>" style="color:white;"><?php echo get_phrase('terms_&_condition'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/refund_policy'); ?>" style="color:white;"><?php echo get_phrase('refund_policy'); ?></a>
                            </li>
                            <!--<li class="nav-item">-->
