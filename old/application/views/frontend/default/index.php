...
<body>
    ...
    <marquee style="font-family: serif;font-size: 15px; height:25px; margin: 2px 0px -4px 0px;background-color: #222222;color: #fff;font-weight: bold;" scrolldelay="50" behavior="alternate" direction="left" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="2"> 
