<?php
  ...
  class Crud_model extends CI_Model {
    ...
    public function get_subjects($param1 = "", $param2="") {
    ...
    function create_quiz_for_users($sub_category_id)
    {
    ...
    public function getResult($quiz_id, $student_id){
      $this->db->select('quiz_result.marks_obt as total_marks, result_detail.*, questions.question, questions.options, questions.explanation');
    ...
    function add_cart($paid_amount=0.00, $total_amount=0.00){
      $data = array(
