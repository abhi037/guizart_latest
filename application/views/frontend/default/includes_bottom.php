...
<script src="<?php echo base_url().'assets/frontend/js/new/jquery-1.12.4.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/popper.min.js'; ?>"></script>
	<script src="<?php echo base_url().'assets/frontend/js/new/bootstrap.min.js'; ?>"></script>
<script src="<?php echo base_url().'assets/frontend/js/bootstrap.min.js'; ?>"></script>
	 <!-- <script src="<?php echo base_url().'assets/frontend/js/new/bootsnav.js'; ?>"></script> -->
    <script src="<?php echo base_url().'assets/frontend/js/new/jquery.appear.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/jquery.easing.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/jquery.magnific-popup.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/modernizr.custom.13711.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/owl.carousel.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/wow.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/progress-bar.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/isotope.pkgd.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/imagesloaded.pkgd.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/count-to.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/YTPlayer.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/jquery.nice-select.min.js'; ?>"></script>
    <script src="<?php echo base_url().'assets/frontend/js/new/loopcounter.js'; ?>"></script>
   
    <script src="<?php echo base_url().'assets/frontend/js/new/main.js'; ?>"></script>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.20/af-2.3.4/b-1.6.1/b-colvis-1.6.1/b-flash-1.6.1/b-html5-1.6.1/b-print-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sp-1.0.1/sl-1.3.1/datatables.min.js"></script>
 <script src="<?php echo base_url().'assets/backend/js/jquery-1.11.0.min.js'; ?>"></script> 
  <script src="<?php echo base_url().'assets/frontend/js/new/plugins.min.js'; ?>"></script>
