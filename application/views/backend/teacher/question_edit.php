<ol class="breadcrumb bc-3">
  ...
  <li><a href="#" class="active"><?php echo get_phrase('edit_questions'); ?></a> </li>
</ol>
  ...
  <div class="col-md-12">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form class="" action="<?php echo site_url('teacher/question_actions/edit/'.$question_id); ?>" method="post" enctype="multipart/form-data">
              <div class="row">
            ...
            <div class="row">
              <div class="col-md-offset-4 col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  <button class = "btn btn-block btn-success" type="submit" name="button"><?php echo get_phrase('update_question'); ?></button>
                </div>
              </div>
            </div>
