  ...
  <div class="col-md-8 col-md-offset-2">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
                <div class="row">
                    <form action="<?php echo site_url('admin/sub_categories/0/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
                    ...
                    <option value="<?php echo $category['id']; ?>" <?php if($sub_category_id == $category['id']) echo 'selected'; ?>><?php echo $category['name']; ?></option>
                                        <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"><?php echo get_phrase('disabled'); ?></label>
                <div class="col-sm-9">
