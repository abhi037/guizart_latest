<ol class="breadcrumb bc-3">
  ...
  <li><a href="#" class="active"><?php echo get_phrase('add_employee'); ?></a> </li>
</ol>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('employee_add_form'); ?>
        </div>
      </div>
      <div class="panel-body">
        <div class="row">
          <form class="" action="<?php echo site_url('usermanagement/employee/add'); ?>" method="post" enctype="multipart/form-data">
            <div class="col-md-8">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          <label class="form-label"><?php echo get_phrase('biography'); ?></label>
                            <div class="controls">
                            <textarea rows="5" class="form-control wysihtml5" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>" name="biography" placeholder="<?php echo get_phrase('biography'); ?>" id="sample_wysiwyg" ></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="form-group">
              <div class="col-md-8 col-sm-8 col-xs-8">
                <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('add_employee'); ?></button>
              </div>
            </div>
          </form>
        </div>
