<ol class="breadcrumb bc-3">
  ...
  <li><a href="<?php echo site_url('admin/subjects'); ?>"><?php echo get_phrase('chapters'); ?></a> </li>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('chapter_add_form'); ?>
        </div>
      </div>
      <div class="panel-body">
        <form action="<?php echo site_url('master/manage/chapters/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
          <div class="col-md-12 col-sm-12 col-xs-12">

            <div class="form-group">
              <label class="col-sm-3 control-label"><?php echo get_phrase('chapter_code'); ?></label>
              <div class="col-sm-5">
                <input type="text" name="code" id="code" class="form-control" readonly value="<?php echo substr(md5(rand(0, 1000000)), 0, 10); ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('chapter_title'); ?></label>
              <div class="col-sm-5">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-5">
                <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('add_chapter'); ?></button>
              </div>
            </div>
          </div>
        </form>
