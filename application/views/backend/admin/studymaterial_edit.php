<ol class="breadcrumb bc-3">
  ...
  <li><a href="<?php echo site_url('admin/studymaterial'); ?>" class=""><?php echo get_phrase('study_material'); ?></a> </li>
  <li><a href="#" class="active"><?php echo get_phrase('edit_study_material'); ?></a> </li>
</ol>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('edit_study_material_form'); ?>
        </div>
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form class="" action="<?php echo site_url('admin/studymaterial_actions/edit/' . $video_id); ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    <label class="form-label"><?php echo get_phrase('doc_title'); ?></label>
                    <div class="controls">
                      <input type="text" name="doc_title" id="doc_title" class="form-control" value="<?php echo (isset($video_detail['doc_title']) ? $video_detail['doc_title'] : ''); ?>" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="form-label"><?php echo get_phrase('doc'); ?></label>
                    <div class="controls">
                      <input type="file" name="doc" id="doc" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
                      <span class="file-input-name"><?php echo (isset($video_detail['file']) ? $video_detail['file'] : ''); ?></span>
                    </div>
                  </div>

                   <div class="form-group">
                    <label class="form-label"><?php echo get_phrase('doc_description'); ?></label>
                    <div class="controls">
              ...
              <div class="row">
                <div class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <button class = "btn btn-block btn-success" type="submit" name="button"><?php echo get_phrase('update_study_material'); ?></button>
                  </div>
                </div>
              </div>
