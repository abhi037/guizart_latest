<div class="row top-bar">
    ...
    <?php  
    if($this->session->userdata('role_id')==3 && $admin_details['is_premium']!=1) { ?>
			<a href="<?php echo base_url('/teacher/becomepremium');?>" class="btn btn-red btn-icon" style="margin: 0px 15px;">
				<?php echo get_phrase('become_premium_teacher'); ?> <i class="fa fa-diamond"></i>
			</a>
		<?php }?>
		<ul class="user-info pull-right pull-none-xsm" style="margin-top: -15px;">
			...
			<li class="profile-info pull-right dropdown"><!-- add class "pull-right" if you want to place this from right -->
				...
				<ul class="dropdown-menu">
					...
					<!-- Profile sub-links -->
					<li>
						<a href="<?php echo site_url("$logged_in_user_role/manage_profile"); ?>">
