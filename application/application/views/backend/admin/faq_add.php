<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('add_faq'); ?></a> </li>
</ol>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo get_phrase('faq_add_form'); ?>
                </div>
            </div>
            <div class="panel-body">
                <form action="<?php echo site_url('admin/faq/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $this->ckeditor->editor("ans",''); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button class = "btn btn-success" type="submit"><?php echo get_phrase('add_faq'); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
