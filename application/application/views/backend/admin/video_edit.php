<ol class="breadcrumb bc-3">
  ...
  <li><a href="<?php echo site_url('admin/videos'); ?>" class=""><?php echo get_phrase('videos'); ?></a> </li>
  ...
  <div class="col-md-offset-3 col-md-6">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form class="" action="<?php echo site_url('admin/video_actions/edit/' . $video_id); ?>" method="post" enctype="multipart/form-data">
              <div class="row">
