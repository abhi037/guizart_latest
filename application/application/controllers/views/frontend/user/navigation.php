...
<div class="sidebar-menu">
    ...
    <ul id="main-menu" class=""> 
      ...
      <li class="<?php echo is_active('my_enroll'); ?>">
        <a href="<?php echo site_url('home/my_enroll'); ?>"><i class="far fa-gem"></i><?php echo get_phrase('enrolled_quiz'); ?></a>
      </li>
      <li class="<?php echo is_active('previousExams'); ?>">
        <a href="<?php echo site_url('home/previousExams'); ?>"><i class="far fa-gem"></i><?php echo get_phrase('previous_quizs'); ?></a>
      </li>
