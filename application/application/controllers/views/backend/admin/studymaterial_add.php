<ol class="breadcrumb bc-3">
  ...
  <li><a href="<?php echo site_url('admin/video'); ?>" class=""><?php echo get_phrase('videos'); ?></a> </li>
  <li><a href="#" class="active"><?php echo get_phrase('add_study_material'); ?></a> </li>
</ol>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('add_study_material_form'); ?>
        </div>
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form action="<?php echo site_url('admin/studymaterial_actions/add'); ?>" method="post" enctype="multipart/form-data" >
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <button class="btn btn-block btn-success" type="submit" name="button"><?php echo get_phrase('add_study_material'); ?></button>
                  </div>
                </div>
              </div> 
            </form>
