...
class Email_model extends CI_Model {
	...
	function password_reset_email($new_password = '' , $email = '')
	{
		...
		if($query->num_rows() > 0)
		{
           $email_msg	=	"<p><strong>Dear , User </span></strong></p>";
			$email_msg	=	"<p><strong>Your password has been changed.</span></strong></p>";
			$email_msg	.=	"Your new password is : ".$new_password."<br />";
			
			$email_msg	.=	"Regards <br> Quizart ";
	...
	public function send_backup($msg=NULL, $sub=NULL, $to=NULL, $from=NULL) { 
		...
		$this->email->to('abhishekkcp98@gmail.com', 'abhishekkcp98@gmail.com');
		$this->email->from($from, get_settings('system_name'));
