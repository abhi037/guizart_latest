<ol class="breadcrumb bc-3">
  ...
  <li><a href="#" class="active"><?php echo get_phrase('master'); ?></a> </li>
   <li><a href="#" class="active"><?php echo get_phrase('chapter'); ?></a> </li>
</ol>
      ...
      <div class="panel-body">
        <div class="row" style="margin-left: -15px;">
          <div class="col-md-offset-4 col-md-3">
            <a href = "<?php echo site_url('master/manage/chapter_form/add_chapter'); ?>" class="btn btn-block btn-info" type="button"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo get_phrase('add_chapter'); ?></a>
          </div>
        </div>
        <table class="table table-bordered datatable" id="table-1">
          <thead>
            <tr>
              <th><?php echo get_phrase('chapter_name'); ?></th>
                ...
                <div class="btn-group">
                  <button class="btn btn-small btn-default btn-demo-space" data-toggle="dropdown"> <i class = "fa fa-ellipsis-v"></i> </button>
                    <ul class="dropdown-menu dropdown-default" role="menu">
                      <li>
                        <a href="<?php echo site_url('master/manage/chapter_form/edit_chapter/'.$subject['id']); ?>">
