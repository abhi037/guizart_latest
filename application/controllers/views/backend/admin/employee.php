...
<ol class="breadcrumb bc-3">
  ...
  <li><a href="#" class="active"><?php echo get_phrase('employee'); ?></a> </li>
</ol>
      ...
      <div class="panel-body"> 
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            <a href = "<?php echo site_url('usermanagement/employee_form/add_employee_form'); ?>" class="btn btn-block btn-info btn-lg" type="button">
              <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_employee'); ?>
            </a>
          </div>
        </div>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu"> 
                    <li>
                      <a href="<?php echo site_url('usermanagement/employee_form/edit_employee_form/'.$user['id']) ?>">
                        <?php echo get_phrase('edit');?>
                      </a>
                    </li>
                    <li class="divider"></li>
                    <li>
                      <a href="#" onclick="confirm_modal('<?php echo site_url('usermanagement/employee/delete/'.$user['id']); ?>');">
