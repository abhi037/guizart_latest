                ...
                <div class="panel-body">
                    <form class="" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('questions_increased_percentage'); ?></label>
                                <div class="controls">
                                    <input type="text" name ="que_inc_per" class="form-control" value="<?php echo get_frontend_settings('que_inc_per'); ?>">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('questions_ask_percentage'); ?></label>
                                <div class="controls">
                                    <input type="text" name = "que_ask_per" class="form-control" value="<?php echo  get_frontend_settings('que_ask_per');?>">
                                </div>
                            </div>

                            <!--<div class="form-group">-->
                            <!--    <label class="form-label"><?php echo get_phrase('real_time_toppers_percentage'); ?></label>-->
                            <!--    <div class="controls">-->
                            <!--        <input type="text" name = "real_topper" class="form-control" value="<?php echo  get_frontend_settings('real_topper');?>">-->
                            <!--    </div>-->
                            <!--</div>-->

                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('refund_policy'); ?></label>
                                <div class="controls">
                                    <textarea rows="5" class="form-control html5editor" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>"
                                        name="about_us" placeholder="<?php echo get_phrase('refund_policy'); ?>"
