...
<ol class="breadcrumb bc-3">
  ...
  <li><a href="<?php echo site_url('usermanagement/employee'); ?>"><?php echo get_phrase('employee'); ?></a> </li>
  <li><a href="#" class="active"><?php echo get_phrase('edit_employee'); ?></a> </li>
</ol>
  ...
  <div class="col-md-12">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        <form class="" action="<?php echo site_url('usermanagement/Employee/edit/'.$user_id); ?>" method="post" enctype="multipart/form-data">
          <div class="col-md-8">
                ...
                <div id="collapseTwo" class="panel-collapse collapse in">
                  <div class="panel-body">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      ...
                      <div class="form-group">
                        <label class="form-label"><?php echo get_phrase('contact_no'); ?></label>
                          <div class="controls">
                            <input type="text" name="contact" id="contact" class="form-control" value="<?php echo $user_data['contact']; ?>" required />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                  <div class="panel-body"> 
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <label class="form-label"><?php echo get_phrase('role'); ?></label>
                        <div class="controls">
                  ...
                  <div class="panel-body">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <textarea rows="5" class="form-control wysihtml5" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>" name="biography" placeholder="<?php echo get_phrase('biography'); ?>" id="sample_wysiwyg" ><?php echo $user_data['biography']; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="form-group">
            <div class="col-md-8 col-sm-8 col-xs-8">
              <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('update_employee'); ?></button>
            </div>
          </div>
        </form>
      </div>
