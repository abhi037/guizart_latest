                  ...
                  <div class="col-lg-3 col-md-6"> 
                    ...
                    <div class="courses-content-bottom">
                      ...
                      ?>
                        ...
                        <h4><a href="<?php echo site_url('Checkout/trail/') . $exam['id'] .'/trial'; ?>"><button class="btn btn-primary">5 Days Trial</button></a></h4>
                      <?php
                        else:
                      ?>
                        <h4><a href="<?php echo site_url('home/paymentRegistration/').$exam['id']; ?>"><button class="btn btn-primary">Enroll Now</button></a></h4>
                        <h4><a href="<?php echo site_url('home/paymentRegistration/') . $exam['id'] .'/trial'; ?>"><button class="btn btn-primary">5 Days Trial</button></a></h4>
                      <?php
                        endif;
                      ?> 
                      <h4 class="price"> 
