  ...
  class Admin extends CI_Controller {
    ...
    public function matrix($param1 = "", $param2 = "") { 
      ...
      elseif ($param1 == "edit") {
        ...
        $this->crud_model->delete_pattern($param2);
        redirect(site_url('admin/matrix'), 'refresh'); 
      }
    ...
    public function pattern_form($param1 = "", $param2 = "", $param3 = "") { 
      $page_data['subjects'] = $this->crud_model->get_subjects('', '', '', $param3)->result_array();
    ...
    function contributor_report()
    {
      $this->session->set_userdata('last_page', 'contributor_report');
      $page_data['page_name'] = 'contributor_report';
      $page_data['page_title'] = get_phrase('contributor_report');
      $page_data['total_question'] = $this->user_model->contributor_report()->result_array();
      $this->load->view('backend/index', $page_data);
    }
    ...
    { 
      $this->session->set_userdata('last_page', 'new_report');
