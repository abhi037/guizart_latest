...
<div class="sidebar-menu">
  ...
  <ul id="main-menu" class="">
    ...
    <?php  
    if($role_id==1 || in_array('/admin/admin_revenue', $urls) || in_array('/admin/enroll_list', $urls) || in_array('/admin/attempted_list', $urls) || in_array('/admin/total_question', $urls) || in_array('/admin/new_report', $urls)) { 
      ?>
