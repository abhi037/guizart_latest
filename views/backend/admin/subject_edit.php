<ol class="breadcrumb bc-3">
  ...
  <li><a href="#" class="active"><?php echo get_phrase('edit_subject'); ?></a> </li>
</ol>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('edit_subject_form'); ?>
        </div>
      </div>
      <div class="panel-body">
        <form action="<?php echo site_url('admin/subjects/edit/'.$subject_id); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
          <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-5">
                <select class="form-control select2" id="samester" name="samester" data-init-plugin="select2" required> 
                  ...
                  <?php foreach ($samesters->result_array() as $samester): ?>
                    <option value="<?php echo $samester['id']; ?>" <?php if(isset($data['samester']) && $data['samester'] == $samester['id']) echo 'selected'; ?>><?php echo $samester['title']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label"><?php echo get_phrase('subject_title'); ?></label>
              <div class="col-sm-5">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-5">
                <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('update_subject'); ?></button>
              </div>
            </div>
          </div>
        </form>
